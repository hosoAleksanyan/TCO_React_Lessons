...
import { updateMovies, deleteMovies } from '../../store/movies/movies.actions';

export const Movies = () => {

    const dispatch = useDispatch();
    const list = useSelector((state)=>state.moviesReducer.movies);
    ...
    return (
        <React.Fragment>
            ...
            <button onClick={handleDelete} >Delete all movies</button>
